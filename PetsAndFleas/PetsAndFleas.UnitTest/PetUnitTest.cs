...
namespace PetsAndFleas.UnitTest
{
    ...
    public class PetUnitTest
    {
        ...
        [TestMethod]
        public void ItShouldInitializeWith100RemainingBites_GivenANewPet()
        {
            // Arrange
            Pet p1 = new Cat();
            Pet p2 = new Cat();
        ...
        [TestMethod]
        public void ItShouldReduceRemainingBites_GivenABiteAmount()
        {
            // Arrange
            Pet p1 = new Cat();
        ...
        [TestMethod]
        public void ItShouldReturnMaxRemainingBites_GivenBiteAmountIsExceedingCapacity()
        {
            // Arrange
            Pet p2 = new Cat();
