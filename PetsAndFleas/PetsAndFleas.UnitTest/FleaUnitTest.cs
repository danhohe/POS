...
namespace PetsAndFleas.UnitTest
{
    ...
    public class FleaUnitTest
    {
        ...
        [TestMethod]
        public void ItShouldReducePetRemainingBites_GivenAValidBiteAmount()
        {
            // Arrange
            Pet p1 = new Cat();
            Flea f1 = new Flea();
        ...
        [TestMethod]
        public void ItShouldReturnRemainingBites_GivenBiteAmountIsExceedingRemainingBites()
        {
            // Arrange
            Pet p1 = new Cat();
            Flea f1 = new Flea();
        ...
        [TestMethod]
        public void ItShouldReturnMaxBites_GivenAnotherPetWithAFullBiteCapacity()
        {
            // Arrange
            Pet p2 = new Cat();
            Flea f1 = new Flea();
        ...
        [TestMethod]
        public void ItShouldReturnZero_GivenANegativeBiteAmount()
        {
            // Arrange
            Pet p3 = new Dog();
            Flea f2 = new Flea();
        ...
        [TestMethod]
        public void ItShouldReturnZero_GivenAFleaNotOnAnyPet()
        {
            // Arrange
            Flea f1 = new Flea();
            Flea f3 = new Flea();
